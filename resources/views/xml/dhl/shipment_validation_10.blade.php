...
<req:ShipmentRequest xmlns:req="http://www.dhl.com" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.dhl.com ship-val-global-req.xsd" schemaVersion="10.0">
	...
	<ExportDeclaration>
		...
		<BillToContactName>Yasin Ugharadar</BillToContactName>
		<BillToAddressLine1>Unit 18, Waters Meeting, Britannia Way</BillToAddressLine1>
		<BillToCity>Bolton</BillToCity>
		<BillToPostcode>BL2 2HH</BillToPostcode>
		<BillToCountryCode>GB</BillToCountryCode>
		...
		<BillToRegistrationNumbers>
            ...
            <RegistrationNumber>
                <Number>{{ $vars['billedToVAT'] }}</Number>
		...
		<OtherCharges>
			<OtherCharge>
				<OtherChargeCaption></OtherChargeCaption>
				<OtherChargeValue>10.00</OtherChargeValue>
				<OtherChargeType>ADMIN</OtherChargeType>
			</OtherCharge>
		</OtherCharges>
	...
	<Place>
		...
		<CompanyName>HR Healthcare Ltd</CompanyName>
		<AddressLine1>{{ $vars['shipper']->Address1 }}</AddressLine1>
		<AddressLine2>{{ $vars['shipper']->Address3 }}</AddressLine2>
		<City>{{ $vars['shipper']->Address4 }}</City>
		<CountryCode>{{ $vars['shipper']->CountryCodeName }}</CountryCode>
