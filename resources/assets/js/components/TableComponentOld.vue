        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="row filters-row">
                    ...
                    <div v-if="filters" class="col-md-3">
                        <v-select placeholder="Select Filters" multiple v-model="selectedFilters"
                            :options="filters"></v-select>
                    </div>
                    <div class="col-md-3">
                        <div class="dropdown float-right">
                            <a class="btn btn-primary waves-effect" v-on:click="printChart($el)"><i class="fa fa-print"
                                    aria-hidden="true"></i></a>
                            <a class="btn btn-primary waves-effect" v-on:click="exportPDF($el)"><i
                            ...
                            <a v-if="csvUrl" class="btn btn-primary waves-effect" :href="csvUrl"><i class="fa fa-file"
                                    aria-hidden="true"></i></a>
                            <a v-else class="btn btn-primary waves-effect"
                                v-on:click="exportCSV(data.data, tableTitle)"><i class="fa fa-file"
                                    aria-hidden="true"></i></a>
            ...
            <div class="card-body">
                ...
                <table v-show="data.data.length >= 1" class="table table-hover">
                    ...
                    <tbody>
                        <tr v-on:dblclick="redirect(item[redirectId])" v-for="item in data.data"
                            ...
                            <td v-if="redirectId || editId || deleteId">
                                <a v-if="redirectId" class="btn btn-blue-grey waves-effect"
                                    v-on:click="redirect(item[redirectId])" v-bind:class="{ 'clickable': redirectId }">
                                    <i class="fa fa-search-plus" aria-hidden="true"></i>
                                </a>
                                <a v-if="editId" class="btn btn-blue waves-effect" v-on:click="edit(item[editId])"
                                    v-bind:class="{ 'clickable': editId }">
                                    <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                </a>
                                <a v-if="deleteId" class="btn btn-red waves-effect"
